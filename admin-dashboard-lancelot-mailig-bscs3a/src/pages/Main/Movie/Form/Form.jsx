        ...
        <form>
          ...
          <div className='field'>
            ...
            <input
              ...
              onChange={(e) => setSelectedMovie({
                ...selectedMovie, original_title: e.target.value
              })}
            />
          </div>
          <div className='field'>
            ...
            <textarea
              ...
              onChange={(e) => setSelectedMovie({
                ...selectedMovie, overview: e.target.value
              })}
            />
          </div>
          ...
          <div className='field'>
            ...
            <input
              ...
              onChange={(e) => setSelectedMovie({
                ...selectedMovie, popularity: e.target.value
              })}
            />
          </div>
          ...
          <div className='field'>
            ...
            <input
              ...
              onChange={(e) => setSelectedMovie({
                ...selectedMovie, release_date: e.target.value
              })}
            />
          </div>
          ...
          <div className='field'>
            ...
            <input
              ...
              onChange={(e) => setSelectedMovie({
                ...selectedMovie, vote_average: e.target.value
              })}
            />
          </div>
